...
import {featuredBooks, superHits} from "../../data/data";
        ...
        <section className="superhits">
            <div className="container featurers-book-container">
                ...
                >
                    ...
                    {superHits.map(({coverLink, writer, cover, nameLink, price, name}, index) => {
                        return (
                    ...
                    <Link to="/superhits" className="btn feature-btn">View All Books <BsArrowReturnRight/></Link>
                </Swiper>
